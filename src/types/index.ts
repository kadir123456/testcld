...
export interface User {
  ...
  // 3 AYRI BAKİYE SİSTEMİ
  freeTrialBalance?: number; // Ücretsiz deneme kazançları
  purchasedBalance?: number; // Satın alınan paket kazançları
  referralBalance?: number; // Referans komisyon kazançları
  balance?: number; // ESKİ - Migration için korunacak
  ...
  referralEarnings?: number; // Toplam referans kazançları (migration için)
  totalReferrals?: number; // Toplam referans sayısı
  purchasedReferrals?: number; // Paket satın alan referanslar
