  ...
  return (
    <div className="space-y-6 pb-20 lg:pb-8">
      ...
      <div className="text-center lg:text-left">
        ...
        <p className="text-gray-400 text-sm md:text-base">Start cryptocurrency mining and earn rewards</p>
      </div>
      ...
      <div className="bg-gray-800/50 backdrop-blur-md rounded-xl p-4 md:p-6 border border-gray-700">
        <h3 className="text-lg md:text-xl font-semibold text-white mb-4">Mining Rules and Information</h3>
