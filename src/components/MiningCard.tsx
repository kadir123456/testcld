...
export const MiningCard: React.FC<MiningCardProps> = ({
  ...
  let expectedDailyEarning = coin.baseEarning * 24; // Daily earnings for the trial
      ...
      <div className="bg-gray-800/50 backdrop-blur-md rounded-xl p-4 md:p-6 border border-gray-700 hover:border-gray-600 transition-all">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs text-purple-300">
                  {user.activePackage === 'starter' ? 'Beginning' :
                   user.activePackage === 'professional' ? 'professional' : 'Institutional'} package
                </span>
              </div>
              <span className="text-xs text-purple-400 font-semibold">
                ${expectedDailyEarning.toFixed(2)}/day
              </span>
            </div>
          </div>
        )}
          ...
          <div className="space-y-4">
            ...
            {timeElapsed && (
              <div className="bg-gray-700/30 rounded-lg p-3">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-400 text-xs">Estimated Earnings</span>
        ...
        {!isActive && (!session || earnings === 0) && (
          <div className="text-center py-6">
            ...
            <p className="text-gray-400 text-sm">{coin.symbol} start mining to earn</p>
            ...
            <p className="text-gray-500 text-xs mt-1">
              expected daily: ${expectedDailyEarning.toFixed(2)}
            </p>
          </div>
        )}
      </div>
