      ...
      <div className="bg-gradient-to-r from-blue-600/95 to-purple-600/95 backdrop-blur-md rounded-xl p-4 border border-blue-500/30 shadow-2xl animate-pulse">
        ...
        <div className="flex items-center space-x-3 mb-3">
          ...
          <div>
            <h3 className="text-white font-semibold text-sm">
              {isNearLimit ? 'The Limit is Approaching!' : 'Go Premium!'}
            </h3>
            <p className="text-blue-100 text-xs">
              {isNearLimit 
                ? `Only $${(25 - (user?.totalTrialEarnings ?? 0)).toFixed(2)} kaldı`
                : 'Upgrade for unlimited earnings'
              }
            </p>
          </div>
        </div>
        ...
        <div className="space-y-2 mb-4">
          <div className="flex items-center space-x-2 text-xs text-blue-100">
            ...
            <span>5x faster mining</span>
          </div>
          <div className="flex items-center space-x-2 text-xs text-blue-100">
            <TrendingUp className="h-3 w-3" />
            <span>Earn up to $25 per day</span>
          </div>
          <div className="flex items-center space-x-2 text-xs text-blue-100">
