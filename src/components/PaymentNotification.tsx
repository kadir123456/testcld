...
export const PaymentNotification: React.FC<PaymentNotificationProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Payment notification sent! Will be reviewed within 24 hours.');
      onClose();
    } catch (error) {
      toast.error('Payment notification could not be sent');
    }
    setLoading(false);
  };
      ...
      <div className="bg-gray-800 rounded-xl p-6 max-w-md w-full border border-gray-700">
        ...
        <div className="mb-6">
          <div className="bg-gray-700/50 rounded-lg p-4 mb-4">
            ...
            <p className="text-sm text-gray-400">{selectedPackage.duration} day duration</p>
          </div>
          ...
          <div className="bg-blue-600/20 border border-blue-500/30 rounded-lg p-4">
            <div className="flex items-start space-x-2">
              ...
              <div className="text-sm text-blue-200">
                ...
                <p>1. To our wallet ${selectedPackage.price} Send USDT (TRC20)</p>
                <p>2. Enter the transaction hash below (optional)</p>
                <p>3. "Report Payment" click on the button</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="Enter the transaction hash if available"
            />
          </div>
          ...
          <div className="flex space-x-3">
            ...
            >
              {loading ? 'Sending...' : 'Report Payment'}
            </button>
          </div>
        </form>
      </div>
